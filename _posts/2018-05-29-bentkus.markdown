...
In 2005 Vidmantas Bentkus introduced a novel [probability concentration inequality](https://arxiv.org/abs/math/0410159). Astonishingly, this inequality has very practical applications in machine learning, for example consider the work of Angelopoulos, Bates et. al. in [2021](https://arxiv.org/abs/2110.01052).
